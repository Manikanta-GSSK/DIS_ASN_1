...
namespace DIS_Assignment1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (flag)
            {
                Console.WriteLine("Yes, Both the array’s reavailable the same string");
            }
            else
            {
                Console.WriteLine("No, Both the array’s don’t reavailable the same string ");
            }
            Console.WriteLine();
        ...
        */
        ...
        /* 
        <summary>
       Given two string arrays word1 and word2, return true if the two arrays reavailable the same string, and false otherwise.
       A string is reavailableed by an array if the array elements concatenated in order forms the string.
       Example 1:
       Input: : bulls_string1 = ["Marshall", "Student",”Center”], : bulls_string2 = ["MarshallStudent ", "Center"]
       Output: true
       Explanation:
       word1 reavailables string "marshall" + "student" + “center” -> "MarshallStudentCenter "
       word2 reavailables string "MarshallStudent" + "Center" -> "MarshallStudentCenter"
       ...
       */
       ...
       Output: 4
       Explanation: Unique elements are [1,3] , sum is 4.
       Example 2:
       Input: bull_bucks = [1,1,1,1,1]
       Output: 0
       Explanation: no unique elements,  sum is 0.
       Example 3:
       Input: bull_bucks = [1,2,3,4,5]
       Output: 15
       Explanation: Unique elements are [1,2,3,4,5], sum is 15.
       </summary>
        */
        ...
        private static int SumOfUnique(int[] bull_bucks)
        {
            ...
            {
                // write your code here
                bool[] v = new bool[bull_bucks.Length];
                int sum = 0;
       ...
       Output: 25
       Explanation: The Diagonals sum is 1 + 5 + 9 + 3 + 7 = 25
       Notice that element mat[1][1] = 5 is being counted only once.
       Example 2:
        ...
        */
        ...
        private static int DiagonalSum(int[,] bulls_grid)
        {
            ...
            {
                // write your code here.
                bool[,] v = new bool[bulls_grid.GetLength(0), bulls_grid.GetLength(0)];
                int sum = 0;
        ...
        */
        ...
        private static string RestoreString(string bulls_string, int[] indices)
        {
            ...
            {
                // write your code here.
                char[] reversed_string = new char[bulls_string.Length];
                for (int i = 0; i < bulls_string.Length; i++)
                {
                    reversed_string[i] = bulls_string[i];
                }
                for (int i = 0; i < indices.Length; i++)
                {
                    reversed_string[indices[i]] = bulls_string[i];
                }
        ...
        Explanation: first occurrence of "c" is in index 4. 
        ...
        */
        ...
        private static string ReversePrefix(string bulls_string6, char ch)
        {
            try
            {
                ...
                if (available)
                {
                    string string1 = bulls_string6.Substring(0, availableAt + 1);
                    string string2 = bulls_string6.Substring(availableAt + 1);
